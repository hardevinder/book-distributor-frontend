...
const LoginPage: React.FC = () => {
  ...
  const [email, setEmail] = useState("admin@example.com"); // dev default
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 via-white to-purple-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        <div className="absolute top-1/4 left-1/4 w-32 h-32 bg-indigo-200 rounded-full mix-blend-multiply filter blur-xl animate-blob"></div>
        <div className="absolute top-1/2 right-1/4 w-48 h-48 bg-purple-200 rounded-full mix-blend-multiply filter blur-xl animate-blob animation-delay-2000"></div>
        <div className="absolute bottom-1/4 left-1/2 w-40 h-40 bg-pink-200 rounded-full mix-blend-multiply filter blur-xl animate-blob animation-delay-4000"></div>
      </div>
      ...
      <div className="w-full max-w-md relative z-10 bg-white/80 backdrop-blur-md shadow-xl rounded-2xl p-8 border border-white/20">
        ...
        <div className="mt-6 text-center">
          <p className="text-xs text-slate-500">
            © 2025 Book Distributor. All rights reserved.
          </p>
        </div>
      </div>
